...
const diaperSchema = z.object({
  subType: z.enum(['wet', 'dirty', 'both', 'dry']),
  startTime: z.date(),
        ...
        >
          <ScrollView contentContainerStyle={styles.scrollContent}>
            <View style={styles.header}>
              <Text variant="title">Log Diaper</Text>
              <Text variant="muted">
                Record {selectedChild?.name}&apos;s diaper change.
              </Text>
            </View>
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, value } }) => (
                      <SegmentedControl
                        ...
                        selectedIndex={['wet', 'dirty', 'both', 'dry'].indexOf(
                          value,
                        )}
                        onValueChange={(index) =>
                          onChange(['wet', 'dirty', 'both', 'dry'][index])
                        }
                      />
                    )}
                  />
